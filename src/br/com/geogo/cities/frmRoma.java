...
public class frmRoma extends JInternalFrame {
	...
	public frmRoma() {
		...
		lblBrasilia.setIcon(new ImageIcon("C:\\Users\\pclgf\\Desktop\\Arquivos\\Java_Programns\\cidadesJInternalFrame\\assets\\img\\cities\\roma.jpeg"));
		lblBrasilia.setBounds(107, 69, 506, 250);
		getContentPane().add(lblBrasilia);
		
		JLabel lblCidade = new JLabel("Roma");
		lblCidade.setFont(new Font("Arial", Font.BOLD, 24));
		lblCidade.setBounds(327, 11, 66, 25);
		getContentPane().add(lblCidade);
		
		JLabel lblPais = new JLabel("It\u00E1lia");
		...
		JLabel lblPopulacaoResp = new JLabel("2,873 milh\u00F5es hab (2017)");
		...
		JLabel lblDensidadeResp = new JLabel("2 232 hab/km\u00B2");
		...
		JLabel lblAreaResp = new JLabel("1 285 km\u00B2");
		...
		JLabel lblLocalizacaoResp = new JLabel("41\u00B0 53' 30\" N 12\u00B0 30' 40\" E");
