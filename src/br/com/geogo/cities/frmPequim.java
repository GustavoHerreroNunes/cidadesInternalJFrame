...
public class frmPequim extends JInternalFrame {
	...
	public frmPequim() {
		...
		lblBrasilia.setIcon(new ImageIcon("C:\\Users\\pclgf\\Desktop\\Arquivos\\Java_Programns\\cidadesJInternalFrame\\assets\\img\\cities\\pequim.jpg"));
		lblBrasilia.setBounds(60, 69, 600, 250);
		getContentPane().add(lblBrasilia);
		
		JLabel lblCidade = new JLabel("Pequim");
		lblCidade.setFont(new Font("Arial", Font.BOLD, 24));
		lblCidade.setBounds(315, 11, 89, 25);
		getContentPane().add(lblCidade);
		
		JLabel lblPais = new JLabel("China");
		...
		JLabel lblPopulacaoResp = new JLabel("21,54 milh\u00F5es hab (2018)");
		...
		JLabel lblDensidadeResp = new JLabel("1 167,3 hab/km\u00B2");
		...
		JLabel lblAreaResp = new JLabel("16 808 km\u00B2");
		...
		JLabel lblLocalizacaoResp = new JLabel("39\u00B0 55' N 116\u00B0 23' E");
