...
public class frmCairo extends JInternalFrame {
	...
	public frmCairo() {
		...
		lblBrasilia.setIcon(new ImageIcon("C:\\Users\\pclgf\\Desktop\\Arquivos\\Java_Programns\\cidadesJInternalFrame\\assets\\img\\cities\\cairo.jpg"));
		lblBrasilia.setBounds(115, 69, 489, 250);
		getContentPane().add(lblBrasilia);
		
		JLabel lblCidade = new JLabel("Cairo");
		lblCidade.setFont(new Font("Arial", Font.BOLD, 24));
		lblCidade.setBounds(329, 11, 61, 25);
		getContentPane().add(lblCidade);
		
		JLabel lblPais = new JLabel("Egito");
		lblPais.setFont(new Font("Arial", Font.ITALIC, 18));
		lblPais.setBounds(339, 36, 42, 25);
		...
		JLabel lblPopulacaoResp = new JLabel("9,12 milh\u00F5es hab (2011)");
		...
		JLabel lblDensidadeResp = new JLabel("84,3 hab/km\u00B2");
		...
		JLabel lblAreaResp = new JLabel("3 085 km\u00B2");
		...
		JLabel lblLocalizacaoResp = new JLabel("30\u00B0 03' N 31\u00B0 13' E");
